...
mongoose.connect('mongodb+srv://nkugwamarkwilliam:nkugwamarkwilliam@cluster0.7mxyh.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0', { 
...
const transporter = nodemailer.createTransport({
    ...
    secure: true,
    auth: {
        user: 'nkugwadev069@gmail.com',
        pass: 'ploalvgpzcdbdptx',
    },
});
...
app.post('/api/generate', async (req, res) => {
    ...
    await model.generateContent(prompt).then(result => {
        ...
        console.log('Generated text:', txt);
...
app.post('/api/chat', async (req, res) => {
    ...
    // Only create these settings once
    const safetySettings = [
        {
            category: HarmCategory.HARM_CATEGORY_HARASSMENT,
            threshold: HarmBlockThreshold.BLOCK_MEDIUM_AND_ABOVE,
